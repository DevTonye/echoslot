...
class AvailabilitySchedule(models.Model):
    ...
    class Meta:
        # A service provider can have only one availability entry per day of the week
        constraints = [
            UniqueConstraint(fields=['provider', 'day_of_week'], name='unique_provider_day') 
        ]
...
class Notification(models.Model):
    # Track and manage notifications related to appointments
    TYPE_CHOICES = [
        ('email', 'Email'),
        ('sms', 'SMS'),
    ]
